...
<h1 align="center">KD Code — AI coding agent for software development</h1>

<p align="center">
  Describe a task in plain language. KD Code explores your project, edits files, runs commands and tests, and shows the actual cost of completed work in Russian rubles.
</p>
...
- Work with permitted project files, commands and tests.
- Choose Claude, GPT, Gemini, GLM and other available models.
- See actual charges and a context savings receipt for completed work.
- Save project notes that should carry over to the next session.
- Connect GitHub, Linear, Notion, Supabase, Sentry, Cloudflare and other apps.
- Schedule recurring project tasks with a per-run ruble budget.
...
## KD Research for unfamiliar codebases
